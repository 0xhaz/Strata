...
# ── mETH vault ──
METH=0xd5Ecc044ff8271De5DDDf2da167fab6179f9fCf2
METH_VAULT=0xCd2f295B6060aa7d992d526AfA55911EEaD7e890
...
v 0xDB829B16F984B45cEDC5EB9e19C58175D91E40C1 src/TrancheToken.sol:TrancheToken "$(cast abi-encode 'c(string,string,uint8,address)' 'Tranche Senior' 'trSR' 18 "$METH_VAULT")"
v 0x18791C016B56FABB124725aD8733c5faaD64281c src/TrancheToken.sol:TrancheToken "$(cast abi-encode 'c(string,string,uint8,address)' 'Tranche Junior' 'trJR' 18 "$METH_VAULT")"
v 0xB711592062498b30749A27547d8936Ec6B90f516 src/DecisionLog.sol:DecisionLog
